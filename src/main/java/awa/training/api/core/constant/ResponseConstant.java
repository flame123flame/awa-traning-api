package awa.training.api.core.constant;

public class ResponseConstant {

	public enum RESPONSE_STATUS {
		SUCCESS, FAILED, DUPLICATE_DATA,OVER_TOTAL,RACK_DUPLICATE
	}
	
	public enum RESPONSE_ACTION {
		GET, SAVE, EDIT,DELETE,SQL,UPLOAD_PDF,UPLOAD_EXCEL,DOWNLOAD_PDF,DOWNLOAD_EXCEL,UPLOAD_IMAGE,EMAIL
	}
